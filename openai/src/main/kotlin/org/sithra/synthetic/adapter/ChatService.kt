...
class ChatService(
    ...
    override suspend fun chat(body: IChatService.ChatRequest): TextMessage {
        val response = config.client.post(chatUrl) {
        ...
        val responseData = json.decodeFromString<Response<TextMessage>>(bodyString)
    ...
    override fun chatStream(
        ...
        config.client.preparePost(chatUrl) {
            contentType(ContentType.Application.Json)
            bearerAuth(config.token)
