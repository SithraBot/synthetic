...
interface IChatService {
    ...
    class ChatRequestBuilder(
         ...
         *
         * @param messages The list of TextMessage objects to be set.
         * @return The current instance of ChatRequestBuilder for chaining.
         */
        fun setMessages(messages: List<TextMessage>) = apply { this.messages = messages }

        /**
         * Sets the list of messages for the chat request by evaluating the given lambda expression.
         *
         * @param messages The lambda expression which returns the list of TextMessage objects to be set.
         * @return The current instance of ChatRequestBuilder for chaining.
         */
        inline fun messages(messages: () -> List<TextMessage>) = setMessages(messages())

        /**
         * Adds a message to the chat request.
         *
         * @param message The TextMessage object to be added to the chat request.
         * @return The current instance of ChatRequestBuilder for chaining.
         */
         ...
         *
         * @param message The lambda expression which returns the TextMessage object to be added to the chat request.
         * @return The current instance of ChatRequestBuilder for chaining.
         */
     ...
     */
    suspend fun chat(body: ChatRequest): IMessage
     ...
     * @return The response from the chat service.
     */
    suspend fun chat(bodyBuilder: ChatRequestBuilder.() -> Unit): IMessage {
